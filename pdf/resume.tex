...
\section{Professional Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \item Compared various model architectures and pre-training strategies for molecular representation learning by evaluating their performance through benchmarking on downstream molecular property prediction tasks.
        \item Preliminary results from the study revealed that Graph Transformer based architectures out-performs BERT-like transformer architectures in 3 out of 5 downstream prediction tasks.
        \item Design and led the development of a web-based platform for computational drug discovery. The platform uses React, REST APIs, MySQL, AWS services, and Git to manage user interactions, data storage, machine learning tasks and version control.
        \item Created CI/CD pipelines for testing and deployment via docker images of the application and maintained infrastructure as code using terraform to support the computational needs for the organization.
        \item Worked with VPCs, DNS configuration, TLS, nginx, and load balancers to configure and manage user requests for the platform securely.
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \item The model achieved an accuracy of 74\% on test data and it was deployed using a Flask-based web framework for text extraction from documents. 
      \resumeItemListEnd
