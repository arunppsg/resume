...
\section{Open Source Contributions}
  \resumeSubHeadingListStart
    \resumeSubItemSimple {Contributed machine learning model architectures to the open scientific machine learning library \href{https://deepchem.io/}{DeepChem} and enhanced the testing infrastructure by contributing to CI/CD pipeline and expanding test coverage {\href{https://github.com/deepchem/deepchem/pulls?q=is\%3Apr+author\%3Aarunppsg+is\%3Aclosed}{(pull requests).}}}
    \resumeSubItemSimple {Implemented the paper \href{https://arxiv.org/abs/2009.07769}{Time Series Anomaly Detection using Generative Adversarial Networks} for performing anomaly detection in time series data \href{https://github.com/arunppsg/tadGAN}{(code).}}
    \resumeSubItemSimple {Contributed code patches to PyTorch (\href{https://github.com/pytorch/pytorch/pulls/arunppsg}{contributions}), a widely used deep learning framework, and PyTorch-Geometric, a deep learning framework designed for implementing graph neural networks (\href{https://github.com/pyg-team/pytorch_geometric/pulls?q=is\%3Apr+author\%3Aarunppsg+is\%3Aclosed}{contributions}).}
  \resumeSubHeadingListEnd

\section{Talks}
  \resumeSubHeadingListStart
    \resumeSubItemSimple {Gave a lightning talk at \href{https://www.youtube.com/watch?v=JEFrzjpf6d0}{Pycon India 2021 } about DeepChem and a 20-min talk at December 2022 monthly FOSS United Bangalore meetup on the same.}
...
\section{Others}
  \resumeSubHeadingListStart
    \resumeSubItemSimple {Earned an A+ grade in the Deep Generative Models online course offered by the Center of Continuing Education at the Indian Institute of Science, Bangalore, in May 2023.}
