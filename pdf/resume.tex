...
\section{Professional Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Deep Forest Sciences}{Bangalore, India}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
		\item Analyzed time-series sales data and built machine learning pipelines using time-series forecasting models for predicting future sales.
...
\section{Open Source Contributions}
  \resumeSubHeadingListStart
    \resumeSubItemSimple {Introduced state-of-the-art machine learning model architectures to the open-source scientific python library \href{https://deepchem.io/}{DeepChem}, introduced new APIs, enhanced testing infrastructure and created tutorial notebooks for users ({\href{https://github.com/deepchem/deepchem/pulls?q=is\%3Apr+author\%3Aarunppsg+is\%3Aclosed}{pull requests}).}}
	...
	\resumeSubItemSimple {Created an open-source TCP/IP packet logging tool capable of capturing and parsing incoming network packets at high speeds (tested up to 50 MB/sec) utilizing ring buffer and memory map (\href{https://github.com/arunppsg/packet-sniffer}{code}).}
  \resumeSubHeadingListEnd
